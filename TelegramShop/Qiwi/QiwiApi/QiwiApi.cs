namespace TelegramShop.Qiwi.QiwiApi
{
    using System;
    ...
    using TelegramShop.Qiwi.QiwiApi.Exceptions;
    using TelegramShop.Qiwi.QiwiApi.Responses;
    ...
    public static class QiwiApi
    {
        ...
        public static async Task<PaymentHistoryResponse> PaymentHistoryAsync(string walletId, Operation operation, int rows = 50,  Source[] sources = null, DateTime? startDate = null, DateTime? endDate = null, DateTime? nextTxnDate = null, long? nextTxnId = null)
        {
            if (!Initialized) throw new NotInitializedException();
