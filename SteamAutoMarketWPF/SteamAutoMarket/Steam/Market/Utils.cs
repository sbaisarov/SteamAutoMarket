namespace Steam.Market
{
    ...
    public static class Utils
    {
        ...
        public static double PriseWithFee(
            double price,
            ...
            double feeMinimum)
        {
            ...
            var priseWithFee = Math.Max(tempPrice, tempFeeMinimum)
                               + Math.Max(Math.Floor(tempPublisherFeePercent * tempPrice), tempFeeMinimum) + Math.Max(
                                   Math.Floor(tempWalletFeePercent * tempPrice),
                                   tempFeeMinimum);
