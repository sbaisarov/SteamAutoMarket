    ...
    public class SteamManager
    {
        ...
        public List<FullRgItem> GetInventoryWithLogs(SteamID steamid, int appid, int contextid)
        {
            ...
            try
            {
                ...
                WorkingProcessForm.LoadingForm.SetTotalItemsCount(inventoryPage.TotalInventoryCount,
        ...
        public bool SaveAccount(SteamGuardAccount account)
        {
            ...
            {
                Logger.Log.Error("Error on session save", ex);
                return false;
            }
        }
