...
namespace Market
{
    public class Invertory
    {
        ...
        public Dictionary<JInvertoryAsset, JDescription> Get(long userId, int appId, int contextId, int count = 500, bool useAuth = false)
        {
            ...
            var dic = respDes.Assets.ToDictionary(x => x, x => respDes.Descriptions.FirstOrDefault(f => f.Classid == x.ClassId));
