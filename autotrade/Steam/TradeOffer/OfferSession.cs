...
namespace autotrade.Steam.TradeOffer
{
    public class OfferSession
    {
        ...
        {            
            ...
            string resp = SteamWeb.Request(url, "POST", data, cookies, referer: referer);
        ...
        public bool Decline(string tradeOfferId)
        {
            ...
            var resp = SteamWeb.Request(url, "POST", data, cookies, referer: referer);
        ...
        internal bool Request(string url, NameValueCollection data, string referer, string tradeOfferId, out string newTradeOfferId)
        {
            ...
            string resp = SteamWeb.Request(url, "POST", data, referer: referer);
            if (!String.IsNullOrEmpty(resp))
            {
                try
                {
