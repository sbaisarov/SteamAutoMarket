...
namespace autotrade.Steam.TradeOffer.Models
{
    public class TradeOffersSummary
    {
        ...
        [JsonProperty("new_received_count")] public int NewReceivedCount { get; set; }
        ...
        [JsonProperty("pending_sent_count")] public int PendingSentCount { get; set; }

        [JsonProperty("newly_accepted_sent_count")]
        public int NewlyAcceptedSentCount { get; set; }

        [JsonProperty("updated_sent_count")] public int UpdatedSentCount { get; set; }
